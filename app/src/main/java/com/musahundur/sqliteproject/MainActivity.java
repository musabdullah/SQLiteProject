package com.musahundur.sqliteproject;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            //database.execSQL("UPDATE musicians SET name ='KirK Hemmet' WHERE id=3");
            ...
            //Cursor cursor = database.rawQuery("SELECT * FROM musicians WHERE age<65", null);
